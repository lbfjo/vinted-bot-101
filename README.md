...
## GitHub Actions
A scheduled workflow (`.github/workflows/vinted-bot.yml`) installs dependencies and runs the CLI. Provide `SLACK_WEBHOOK_URL` and/or `DISCORD_WEBHOOK_URL` as secrets in your repository settings.
